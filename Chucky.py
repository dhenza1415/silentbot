...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EsqsTe59FJodu39cPGRa.CI/G0Iq10F7tZZ1mkdC7QG.AyE58hgNiE3OGGQRcTOJT6ZCqZNAffuAHy/zmhjGDjA=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EsVjt0IKlEFo61QYIXB5.WC83nwBFW3Fe2WGaGduzfq.tAV4LOjhOvvOR9WnlvLfamQuS1CAKQoc84shV0uPvh4=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Esj0Kj7C145Rrs1S2Ord.X2TxK9WSaVoUw1Ycse66Zq.W3np52AHNVDjEQ77pD82cIgOb8rSX9ekKe5lSoLc1JY=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Esfhf219R5Ph2tyVGRyc.o3nnfkRfr+wcsBIZPXAupa.TA+0ACnhKhwbFC5LGPV8UcHBWTKHSKO0giPyDdSPxj8=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EsEAm7jzSjxchn4yclZc.LaFUYaCak4HmTFtS7+9TBa.psOSQfZBUhtLr7HBy79m071IcXMIQaQQHaUZ7EQPZqc=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Es3nQP3OsWev6xsTjUV9.oOvJll1Er5/crPw4tADpwq.ZfFoorPTeg1doHy6sWxuMuVKWucWUNfFTa+yaePHz58=')
km.loginResult()
...
╚═══════════════════
"""
tjia="ufdc20b3a00b5e8f31e4f91017eb361b0"
...
admin=["ufdc20b3a00b5e8f31e4f91017eb361b0","u23ad5ddec0dd0523f9caffad673d693c","u8b2bb5214c1afc77d06901a535c23e30","u57a54b914085fea6f04c19f6fe589057"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Dhenza15",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Terimakih slam knal dan Jangan lupa anu",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
    ...
    try:
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            cl.sendMessage(c)
            cl.sendText(op.param1,"Hallo " + cl.getContact(op.param2).displayName + "\nWelcome To ☞ " + str(ginfo.name) + " ☜" + "\nBudayakan Cek Note No baper Dan Semoga Betah Disini 😊😊😊")
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 25:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["yg tag pasti kurang anu😁😁😁","tag lagi cipok pake doser😤😤😤","Jangan tag anu aja",cName + " Ngapain tag kangen adit bilang",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Tag Mulu Lo Anjirr!","Dia Lagi Off", cName + " Kenapa Tag? Kangen?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Ig: Dhenza15 FOUNDER BHSC")
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Silent Dihapus")
                        except:
                            pass
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus FOUNDER BHSC")
...
#		    cl.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Siap On Cari tikungan")
                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Cek Sider Off Sepi ah gd yg bisa di tikung")
                else:
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Tagall","Tag","Colek","Cipok"]:
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "ufdc20b3a00b5e8f31e4f91017eb361b0"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		try:
		    ...
		    wait["Leave"] = False
		          ...
		          cl.sendText(msg.to,"Bilang Dulu Sama Bang dhenza")		    
		    

            elif msg.text in ["Absen"]:
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"ANTON HADIR")
                kk.sendText(msg.to,"ROBET HADIR")
                kc.sendText(msg.to,"JONI HADIR")
                kr.sendText(msg.to,"Hadir semua BOS siap Nikung")
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Manggil mele ayu nikung") 
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Bang adit")
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        gs = kk.getGroup(msg.to)
                        gs = kc.getGroup(msg.to)
                        ki.sendText(msg.to,"Rata gak rata penting dah kibar~~")
                        kc.sendText(msg.to,"☣Hay slam knal smua 🤗🤗 mohon maaf room nya mau di sapu dullu papay☞☞🏁🏁🏁")
                        targets = []
                        for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["https://timeline.line.me/post/_dYvwGRnJP30Lr5y_hHhH1NSbO2WfXQkdB4nfI_w/1152553409108059350"]
